    ...
    <header className="z-50 relative">
      <motion.div
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white 
            ...
            dark:bg-slate-950 dark:border-black/40 dark:bg-opacity-75"
        ...
        >
          {links.map((link) => (
            ...
            >
              <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 hover:text-slate-950 transition dark:text-slate-300 dark:hover:text-slate-100",
                  {
