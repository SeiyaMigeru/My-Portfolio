  ...
  return (
    ...
    >
      <Link href={href} target="_blank">
        <section
          className="bg-slate-300 max-w-[42rem] border border-black/5 overflow-hidden 
        sm:pr-8 relative sm:h-[20rem] hover:bg-slate-400 transition sm:group-even:pl-8 
        rounded-md dark:bg-white/10 dark:hover:bg-white/20 dark:text-white"
        >
          <div
